...
const TeamPage = () => {
  ...
  return (
    <div className="md:pt-28 py-24 px-5 md:px-10 justify-center mx-auto max-w-screen-xl md:pb-20">
      ...
      <h2 className="first md:text-3xl font-light text-2xl text-[#444444] py-8 underline pb-5">Executive Officers</h2>
      ...
      <h2 className="first md:text-3xl font-light text-2xl text-[#444444] py-8 underline pt-16">Senior Leadership</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      {/* Senior Leadership Section */}
      <h2 className="first md:text-3xl font-light text-2xl text-[#444444] py-8 underline pt-16">Board Members</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      {/* Senior Leadership Section */}
      <h2 className="first md:text-3xl font-light text-2xl text-[#444444] py-8 underline pt-16">Advisors</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {advisors.map((member) => {
          const isExpanded = expandedDescriptionId === member.id;
          const shortDescription = member.description.split(" ").slice(0, 75).join(" ") + "...";
